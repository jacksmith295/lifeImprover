...
let StatsController = class StatsController {
    ...
    async getStatsByCategory(req, period) {
        return this.statsService.getStatsByCategory(req.user.id, period);
    }
    async getWeeklyGoalStats(req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StatsController.prototype, "getTaskStats", null);
__decorate([
    (0, common_1.Get)('tasks/by-category'),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    (0, common_1.Get)('weekly-goals'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StatsController.prototype, "getWeeklyGoalStats", null);
